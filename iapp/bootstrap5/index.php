    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        <img src="./img/images/hms.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Medicos especializados</h5>
                            <p>Some representative placeholder content for the first slide.</p>
                        </div>
                    </div>
                    <div class="carousel-item" data-bs-interval="2000">
                        <img src="./img/images/hms2.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="carousel-item">
                        <img src="./img/images/hms3.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    <div class="card">
                        <img src="./img/images/especialista.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Medicos especialista</h5>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="./img/images/hospitaliza.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="./img/images/Microscopio.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
